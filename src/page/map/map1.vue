...
<script type="text/ecmascript-6">
  export default {
    ...
    mounted () {
      // 百度地图API功能
      // 创建Map实例
      let map = new BMap.Map('mapwrap', {enableMapClick: true})
      // 初始化地图,设置中心点坐标和地图级别
      ...
      const beijingPosition = new BMap.Point(116.432045, 39.910683),
        ...
        point = [beijingPosition, hangzhouPosition, taiwanPosition]

      const curve = new BMapLib.CurveLine(point, {strokeColor: 'blue', strokeWeight: 3, strokeOpacity: 0.5})// 创建弧线
